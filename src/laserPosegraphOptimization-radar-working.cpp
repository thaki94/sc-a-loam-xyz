...
void radarHandler(const sensor_msgs::Image::ConstPtr& msg)
{
    ...
    int nearestIndex = findNearestIndexBinarySearch(keyframeTimes, timestamp_sec);

    ROS_INFO("Nearest Lidar idx: %d", nearestIndex);
            ...
            if( ! gtSAMgraphMade /* prior node */) {
                ...
                mtxPosegraph.lock();
                {
                    ...
                    if(hasGPSforThisKF) {
                        ...
                        gtsam::Point3 gpsConstraint(transxyz[0], transxyz[1], curr_altitude_offseted);
